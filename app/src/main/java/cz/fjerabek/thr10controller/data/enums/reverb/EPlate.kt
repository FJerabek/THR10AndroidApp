...
enum class EPlate(val id : Byte, val max : Short, val  min : Short, val dumpPosition: Pair<Int, Int>) :
    ...
    HIGH_RATIO(IDReverb.IDPlate.HIGH_RATIO, 10,  1, Pair(218, -1)),
    LOW_RATIO(IDReverb.IDPlate.LOW_RATIO, 14,  1, Pair(219, -1)),
    LEVEL(IDReverb.IDPlate.LEVEL, 0x64,  0x00, Pair(220, -1));
