...
enum class ERoom( val id : Byte, val max : Short, val min : Short, val dumpPosition: Pair<Int, Int?>) :
    ...
    HIGH_RATIO(IDReverb.IDRoom.HIGH_RATIO, 10,  1, Pair(218, null)),
    LOW_RATIO(IDReverb.IDRoom.LOW_RATIO, 14,  1, Pair(219, null)),
    LEVEL(IDReverb.IDRoom.LEVEL, 0x64,  0x00, Pair(220, null));
